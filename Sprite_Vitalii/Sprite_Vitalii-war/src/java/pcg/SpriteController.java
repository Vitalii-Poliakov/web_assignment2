...
import pcg.util.JsfUtil;
import pcg.util.PaginationHelper;
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private cst8218.pol1169.entity.SpriteFacade ejbFacade;
    ...
    private cst8218.pol1169.entity.SpriteFacade getFacade() {
        return ejbFacade;
    }
